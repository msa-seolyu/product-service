package com.seolyu.productservice.common.error.aop;

import com.seolyu.productservice.common.utils.SlackWebhookUtil;
...
public class UserErrorAspect {
    ...
    public void sendSlackErrorAlam(JoinPoint joinPoint, Object returnValue) {
        ...
        String title = "[product-service] 500번대(서버) 오류가 났어요! [requestId] " + requestId;
        try {
